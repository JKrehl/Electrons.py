...
class FlatAtomDW(PlaneOperator):
	def __init__(self, atoms, y, x, k,  phaseshifts_f=None, roi=None, yoi=None, xoi=None, ky=None, kx=None, kk=None, z=None, atom_potential_generator=WeickenmeierKohl, lazy=False, forgetful=False):
		self.__dict__.update(dict(atoms=atoms, y=y, x=x, z=z,
